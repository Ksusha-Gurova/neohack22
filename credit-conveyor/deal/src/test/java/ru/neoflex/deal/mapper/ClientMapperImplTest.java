...
class ClientMapperImplTest {
    ...
    @Test
    void mapDtoToEntityShouldReturnClientTest() {
        assertThat(mapper.mapDtoToEntity(loanApplicationRequestDTO))
                .isNotNull()
                .isEqualTo(client);
    }

    @Test
    void loanApplicationRequestDTOToPassportShouldReturnPassportTest() {
        assertThat(mapper.loanApplicationRequestDTOToPassport(loanApplicationRequestDTO))
                .isNotNull()
                .isEqualTo(passport);
    }
}